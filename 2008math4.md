...
拙文で挙げた[プログラミング言語(リンク)](https://github.com/zettsu-t/zettsu-t.github.io/wiki/If-programming-languages-were)についてVBA, HTML, CSS以外を使い、C#, VB.NET, Perl, Python, Groovy, PHP, Scheme, OCaml, F#, Rust, [Kuin](https://twitter.com/kuina_ch/status/847779940866981888) でも書きました。Cygwinターミナルから、makeを引数なしで実行すると、ビルド、実行、実行結果の検査を行います。
...
2017年3月時点の[TIOBE index](http://www.tiobe.com/tiobe-index)におけるratingsについて、上記の言語の合計は20位以内の言語で53.2%, 50位以内の言語で56.8%です。半分確保するのはなかなか大変です(下記の表は[https://www.tiobe.com/](https://www.tiobe.com/)を基に作成)。

|TIOBE index 順位|Programming Language|Ratings[%]|累積[%]|
|:--|:------|:------|:------|
|1|Java|16.384|16.384|
|2|C|7.742|24.126|
|3|C++|5.184|29.310|
|4|C#|4.409|33.719|
|5|Python|3.919|37.638|
|6|Visual Basic .NET|3.174|40.812|
|7|PHP|3.009|43.821|
|8|JavaScript|2.667|46.488|
|11|Perl|2.261|48.749|
|12|Ruby|2.254|51.003|
|13|Assembly language|2.232|53.235|
|30|Scala|0.719|53.954|
|32|F#|0.688|54.642|
|36|Haskell|0.502|55.144|
|37|Scheme|0.478|55.622|
|38|Groovy|0.466|56.088|
|43|Rust|0.382|56.470|
|44|Bash|0.348|56.818|
|-|Clojure|||
|-|OCaml|||
|-|Makefile|||
|-|Kuin|||
...
Cartesian productを求めるコードは、下記の記事にあるコードを使用してます。
...
つい先ほど(2017/3/31)限定配布されていたプログラミング言語です。ですので、このプログラミング言語でコードを書いた方はほとんどいないと思われます。

https://twitter.com/kuina_ch/status/847779940866981888

http://kuina.ch/others/license
...
makeからビルドして実行します。一通り解を列挙できたようです。
