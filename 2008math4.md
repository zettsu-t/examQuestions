...
2017年8月時点の[TIOBE index](http://www.tiobe.com/tiobe-index)におけるratingsについて、上記の言語の合計は20位以内の言語で45.6%, 50位以内の言語で49.2%です。半分にも達していません(下記の表は[https://www.tiobe.com/](https://www.tiobe.com/)を基に作成)。

|TIOBE index 順位|Programming Language|Ratings[%]|累積[%]|
|:--|:------|:------|:------|
|1|Java|12.961|12.961|
|2|C|6.477|19.438|
|3|C++|5.55|24.988|
|4|C#|4.195|29.183|
|5|Python|3.692|32.875|
|6|Visual Basic .NET|2.569|35.444|
|7|PHP|2.293|37.737|
|8|JavaScript|2.098|39.835|
|9|Perl|1.995|41.830|
|10|Ruby|1.965|43.795|
|14|Assembly language|1.805|45.600|
|28|Scala|0.888|46.488|
|31|Erlang|0.737|47.225|
|39|F#|0.573|47.798|
|42|Clojure|0.512|48.310|
|47|Haskell|0.453|48.763|
|48|Groovy|0.433|49.196|
|-|Bash|||
|-|Elixir|||
|-|Scheme|||
|-|OCaml|||
