...
2017年3月時点の[TIOBE index](http://www.tiobe.com/tiobe-index)におけるratingsについて、上記の言語の合計は20位以内の言語で53.2%, 50位以内の言語で57.2%です。半分確保するのはなかなか大変です(下記の表は[https://www.tiobe.com/](https://www.tiobe.com/)を基に作成)。
...
|41|Erlang|0.412|56.500|
|43|Rust|0.382|56.882|
|44|Bash|0.348|57.230|
|-|Elixir|||
|-|Clojure|||
|-|OCaml|||
|-|Makefile|||
