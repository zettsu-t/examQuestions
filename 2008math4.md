...
Closure (the Groovy programming language) もEvalが使えます。私にとっては初めてのClosureプログラミングなので、もっとよい書き方があると思います。
...
拙文で挙げた[プログラミング言語](https://github.com/zettsu-t/zettsu-t.github.io/wiki/If-programming-languages-were)について、VBA以外は書けました。C++はCを兼ねる、HTMLとCSSは除外、ということで。
