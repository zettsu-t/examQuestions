...
拙文で挙げた[プログラミング言語(リンク)](https://github.com/zettsu-t/zettsu-t.github.io/wiki/If-programming-languages-were)についてVBA, HTML, CSS以外を使い、C#, VB.NET, Perl, Python, Groovy, Scheme, OCaml, F#, Rustでも書きました。Cygwinターミナルから、makeを引数なしで実行すると、ビルド、実行、実行結果の検査を行います。
...
2017年3月時点の[TIOBE index](http://www.tiobe.com/tiobe-index)におけるratingsについて、上記の言語の合計は20位以内の言語で50.2%, 50位以内の言語で53.8%です。半分確保するのはなかなか大変です(下記の表は[https://www.tiobe.com/](https://www.tiobe.com/)を基に作成)。
...
|8|JavaScript|2.667|43.479|
|11|Perl|2.261|45.740|
|12|Ruby|2.254|47.994|
|13|Assembly language|2.232|50.226|
|30|Scala|0.719|50.945|
|32|F#|0.688|51.633|
|36|Haskell|0.502|52.135|
|37|Scheme|0.478|52.613|
|38|Groovy|0.466|53.079|
|43|Rust|0.382|53.461|
|44|Bash|0.348|53.809|
|-|Clojure|-|-|
|-|OCaml|-|-|
|-|Makefile|-|-|
