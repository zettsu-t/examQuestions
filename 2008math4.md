...
2017年4月時点の[TIOBE index](http://www.tiobe.com/tiobe-index)におけるratingsについて、上記の言語の合計は20位以内の言語で50.4%, 50位以内の言語で54.0%です。半分確保するのはなかなか大変です(下記の表は[https://www.tiobe.com/](https://www.tiobe.com/)を基に作成)。

|TIOBE index 順位|Programming Language|Ratings[%]|累積[%]|
|:--|:------|:------|:------|
|1|Java|15.568|15.568|
|2|C|6.966|22.534|
|3|C++|4.554|27.088|
|4|C#|3.579|30.667|
|5|Python|3.457|34.124|
|6|PHP|3.376|37.500|
|7|Visual Basic .NET|3.251|40.751|
|8|JavaScript|2.851|43.602|
|10|Perl|2.413|46.015|
|11|Ruby|2.31|48.325|
|13|Assembly language|2.168|50.493|
|31|Scala|0.727|51.220|
|34|Scheme|0.552|51.772|
|36|Groovy|0.473|52.245|
|38|Haskell|0.434|52.679|
|40|Erlang|0.409|53.088|
|41|Rust|0.375|53.463|
|42|Bash|0.363|53.826|
|49|Clojure|0.262|54.088|
|-|Elixir|||
|-|OCaml|||
|-|F#|||
|-|Makefile|||
