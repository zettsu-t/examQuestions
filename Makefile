...
VSPROJECT_DIR=vsproject/cs2008math4
...
TARGET_2008_CS=$(VSPROJECT_DIR)/$(CS_DIR)/bin/$(VSPROJECT_TARGET)/cs2008math4
TARGET_2008_HASKELL=2008math4hs
TARGET_2008_RUST=2008math4rs
TARGETS=$(TARGET_2006) $(TARGET_2008_CPP) $(TARGET_2008_ASM) $(TARGET_2008_CS) $(TARGET_2008_HASKELL) $(TARGET_2008_RUST)
...
SOURCE_2008_CS=$(VSPROJECT_DIR)/$(CS_DIR)/2008math4cs.cs
...
$(TARGET_2008_CS): $(SOURCE_2008_CS)
	cd $(VSPROJECT_DIR); $(MSBUILD) $(SOLUTION_CS) $(MSBUILDFLAGS)
	$@
