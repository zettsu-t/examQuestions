...
OBJ_2008_ASM_CPP=2008math4a.o
OBJ_2008_ASM_S=2008math4asm.o
OBJS=$(OBJ_2008_CPP) $(OBJ_2008_ASM_CPP) $(OBJ_2008_ASM_S)

SOURCE_2006=2006math5.hs
SOURCE_2008_CPP=2008math4.cpp
SOURCE_2008_ASM_CPP=2008math4a.cpp
...
$(TARGET_2008_ASM): $(OBJ_2008_ASM_CPP) $(OBJ_2008_ASM_S)
	$(LD) $(LIBPATH) -o $@ $^ $(LDFLAGS) $(LIBS)
	./$@
...
$(OBJ_2008_ASM_CPP) : $(SOURCE_2008_ASM_CPP)
